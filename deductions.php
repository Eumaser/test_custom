    ...
    switch ($action) {
        case "create":
            if($o->create()){
                ...
                rediectUrl("deductions.php?action=edit&deductions_id=$o->deductions_id",getSystemMsg(1,'Create data successfully'));
            }else{
        ...
        case "update":
            if($o->update()){
                ...
                rediectUrl("deductions.php?action=edit&deductions_id=$o->deductions_id",getSystemMsg(1,'Update data successfully'));
            }else{
                $_SESSION['status_alert'] = 'alert-error';
