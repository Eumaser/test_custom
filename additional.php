    ...
    switch ($action) {
        case "create":
            if($o->create()){
                ...
                rediectUrl("additional.php?action=edit&additional_id=$o->additional_id",getSystemMsg(1,'Create data successfully'));
            }else{
        ...
        case "update":
            if($o->update()){
                ...
                rediectUrl("additional.php?action=edit&additional_id=$o->additional_id",getSystemMsg(1,'Update data successfully'));
            }else{
                $_SESSION['status_alert'] = 'alert-error';
