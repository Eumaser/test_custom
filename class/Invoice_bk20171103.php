                ...
                <form id = 'invoice_form' class="form-horizontal" action = '<?php echo $this->document_url;?>?action=create' method = "POST">
                  <div class="box-body col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <label for="invoice_regards" class="<?php echo $label_col_sm;?> control-label">Notes to Customer</label>
                            <div class="<?php echo $field_col_sm;?>">
                                <textarea class="form-control" rows="3" id="invoice_regards" name="invoice_regards" placeholder="Notes to Customer" <?php echo $disabled;?>><?php echo $this->invoice_regards;?></textarea>
                            </div>
                        </div>
...
//                    '<td style = "width:20px;"><input type = "checkbox" style = "width:20%" id = "invl_istax_@i" class = "minimal isincludetax"/></td>'+
    ...
    $(document).ready(function() {
        <?php if(($this->document_type != 'SCN' && $this->document_type != 'PCN' && $isgenerated != 1)){ 
                
            ?>                
            addline(); 
        <?php  }else if($this->document_type == 'SI' || $this->document_type == 'PCN' || $this->document_type == 'SCN'){
        ...
        <tbody>
            ...
            ?>
                <tr id = "line_<?php echo $line;?>" class="tbl_grid_odd" line = "<?php echo $line;?>">
                    ...
                    <td style="width:400px;"><textarea rows="1" cols="15" id = "invl_pro_desc_<?php echo $line;?>" class="form-control" <?php echo $readonly;?>><?php echo html_entity_decode($row['invl_pro_desc']);?></textarea></td>
