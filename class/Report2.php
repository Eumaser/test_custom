...
<!-- Main content -->
                    <section class="content">
                        <div class="box box-success">
                            ...
                            <form id = 'report_form' class="form-horizontal" action = 'report2.php?type=<?php echo $this->type; ?>' method = "POST" enctype="multipart/form-data">
                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content">
                                            <div class="active tab-pane" id="<?php echo $this->type;?>">
                                                ...
                                                <div class="form-group">
                                                    <label for="report_order" class="<?php echo $label_col_sm;?> control-label">Quotation No.</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="report_order" name="report_order" value = "<?php echo $this->report_order;?>" placeholder="KC/0001/17-01">
                                                    </div>
                                            ...
                                            <!--<div class=" tab-pane <?php if($this->current_tab == "Detailed"){ echo 'active'; $this->type = 'detailed';}?>" id="detailed">
                                                ...
                                                <div class="form-group">
                                                    <label for="detailed_order" class="<?php echo $label_col_sm;?> control-label">Quotation No.</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="detailed_order" name="detailed_order" value = "<?php echo $this->detailed_order;?>" placeholder="IV/170100001">
                                                    </div>
                                                </div>
                                                <div class="form-group">
    ...
    function printBtn(){
            ...
            theForm.action = 'report2_print.php';
            theForm.method = 'post';
            ...
            newInput5.name = 'report_order';
            newInput5.value = order;
    ...
    public function fetchReportSummary($wherestring,$orderstring,$wherelimit,$type){
        $sql = "SELECT 
                ...
                $wherestring ORDER BY ord.order_date DESC, ord.order_id DESC $wherelimit";
        $query = mysql_query($sql);
        if($type > 0){
            $row = mysql_fetch_array($query);
            $this->summary_order_no           = $row['order_no'];
            $this->summary_order_date         = $row['order_date'];
            $this->summary_order_customer     = $row['order_customer'];
            $this->summary_partner_name         = $row['partner_name'];
            $this->summary_order_salesperson  = $row['order_salesperson'];
            $this->summary_empl_name            = $row['empl_name'];
            $this->summary_order_subtotal     = $row['order_subtotal'];
            $this->summary_order_taxtotal     = $row['order_taxtotal'];
            $this->summary_order_grandtotal   = $row['order_grandtotal'];
            $this->summary_order_id           = $row['order_id'];
            $this->summary_order_prefix_type  = $row['order_prefix_type'];            
        }
        return $query;
    } 
    public function fetchReportDetailed($wherestring,$orderstring,$wherelimit,$type){
        $sql = "SELECT 
                ...
                $wherestring GROUP BY ord.order_no
                    HAVING COUNT(ordl.ordl_pro_id) > 0
                    ORDER BY ord.order_date DESC, ord.order_id DESC $wherelimit";
        $query = mysql_query($sql);
        if($type > 0){
            $row = mysql_fetch_array($query);
            $this->summary_order_no           = $row['order_no'];
    ...
    <table id="summary_table" class="table summary-data table-bordered table-striped">
        <thead>
          <tr>
            ...
            <th class = "" style = 'width:100px;'>Quotation</th>
        ...
        ?>
            <tr id = "line_<?php echo $line;?>" class="tbl_grid_odd" line = "<?php echo $line;?>">
                ...
                <td style="width:100px;padding-left:5px"><?php echo $row['order_no'];?></td>
                <td style="width:100px;padding-left:5px"><?php echo format_date($row['order_date']);?></td>
                ...
                <td style="width:80px;padding-left:5px"><?php echo $row['order_subtotal'];?></td>
                <td style="width:80px;padding-left:5px"><?php echo $row['order_taxtotal'];?></td>
                <td style="width:80px;padding-left:5px"><?php echo $row['order_grandtotal'];?></td>
            </tr>               
        <?php
    ...
    <table id="summary_table" class="table summary-data table-bordered">
        ...
        ?>
            <tr id = "line_<?php echo $line;?>" class="tbl_grid_odd" line = "<?php echo $line;?>" style="background-color:#<?php echo $mcolor; ?>;">
                ...
                <td style="width:100px;padding-left:5px"><b><?php echo $row['order_no'];?></b></td>
                <td style="width:100px;padding-left:5px"><b><?php echo format_date($row['order_date']);?></b></td>
                ...
                <td style="width:80px;padding-left:5px"><b><?php echo $row['order_subtotal'];?></b></td>
                <td style="width:80px;padding-left:5px"><b><?php echo $row['order_taxtotal'];?></b></td>
                <td style="width:80px;padding-left:5px"><b><?php echo $row['order_grandtotal'];?></b></td>
            </tr>     
                ...
                $detailSql = "SELECT    ordl.ordl_id,
                        ...
                        /*"SELECT    ordl.ordl_id,
                            ...
                            FROM `db_ordl` ordl
                                LEFT JOIN db_product prod ON prod.product_id = ordl.ordl_pro_id
                                LEFT JOIN db_category cat ON cat.category_id = prod.product_category
                            WHERE ordl.ordl_order_id = '".$row['order_no']."' 
                            ORDER BY ordl.ordl_id, ordl.ordl_item_type ASC";*/
        ...
        ?>   
            <tr id = "line_<?php echo $line;?>" class="tbl_grid_odd" line = "<?php echo $line;?>" style="">
                <td style="width:30px;padding-left:5px"></td>
                <td style="width:100px;padding-left:5px"><?php echo $drow['ordl_item_type'];?></td>       
                ...
                <td style="width:80px;padding-left:5px"><?php echo $drow['ordl_qty'];?></td>
                <td style="width:80px;padding-left:5px"><?php echo $drow['ordl_uprice'];?></td>
                <td style="width:80px;padding-left:5px"><?php echo $drow['ordl_total'];?></td>
            </tr>
        <?php       
                }             
            }
