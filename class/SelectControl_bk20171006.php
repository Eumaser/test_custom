...
//echo $sql;die;
    ...
    **/
    ...
    /*public function getSalespersonSelectCtrl($pid,$shownull="Y",$wherestring=''){
        $sql = "SELECT empl_id,empl_name from db_empl WHERE (empl_id = '$pid' or empl_id >0) and empl_status = 1 $wherestring
                ORDER BY empl_seqno,empl_name ASC"; 
