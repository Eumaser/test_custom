                  ...
                  <div class="box-body col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="<?php echo $field_col_sm;?>">
                              ...
                              <p></p>
                              <textarea class="form-control" rows="2" id="invoice_remarks_remark" name="invoice_remarks_remark" placeholder="Remarks" <?php echo $disabled;?>><?php echo $this->invoice_remarks_remark;?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
      ...
      if($this->document_type == 'SI'){
            ...
            if($query){
                ...
                $invoice = array(
                    ...
                    'invoice_attentionto_name'  => $this->e_invoice_firstname .' '. $this->e_invoice_lastname,
                    'invoice_attentionto_email' => $this->e_invoice_email,
                    'invoice_attentionto_phone' => $this->e_invoice_telephone,
                    'invoice_billaddress'       => $this->e_invoice_payment_address_1 .' '. $this->e_invoice_payment_address_2 .' \n'. $this->e_invoice_payment_postcode .' '. $this->e_invoice_payment_city .' '. $this->e_invoice_payment_country,
                    'invoice_shipaddress'       => $this->e_invoice_payment_address_1 .' '. $this->e_invoice_payment_address_2 .' \n'. $this->e_invoice_payment_postcode .' '. $this->e_invoice_payment_city .' '. $this->e_invoice_payment_country,
                    'invoice_remark'            => 'SO ' . $this->e_invoice_order_id .', customer from e-commerce: \n' . $this->e_invoice_firstname .' '. $this->e_invoice_lastname .' \n'. $this->e_invoice_email .' \n'. $this->e_invoice_telephone  .' \n'. $this->e_invoice_payment_address_1 .' '. $this->e_invoice_payment_address_2 .' \n'. $this->e_invoice_payment_postcode .' '. $this->e_invoice_payment_city .' '. $this->e_invoice_payment_country,
                );
                /* 
                 * Generate Invoice 
                 */
                if($this->generateInvoice($invoice)){
                    $this->newinvoice_id = $this->invoice_id;
                    $pro->fetchProductDetail(" AND product_no = '" . $this->e_invoice_model ."'","","",1);
                    $invoiceline = array(
                        'invl_pro_id'       => $pro->product_id,
                        'invl_pro_desc'     => $pro->product_desc,
                        'invl_qty'          => $this->e_invoice_quantity,
                        'invl_uprice'       => $this->e_invoice_price,
                        'invl_total'        => $this->e_invoice_price,
                        'invl_fuprice'      => $this->e_invoice_price,
                        'invl_ftotal'       => $this->e_invoice_price,
                    );
                    /* 
