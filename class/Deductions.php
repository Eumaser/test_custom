          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;' onclick = "window.location.href='deductions.php'">Search</button>
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;margin-right:10px;' onclick = "window.location.href='deductions.php?action=createForm'">Create New</button>
                <?php }?>
              </div>
                  ...
                  <table id="deductions_table" class="table table-bordered table-hover">
                    ...
                    <?php   
                      $sql = "SELECT l.*,empl.empl_name
                              ...
                              WHERE l.deductions_id > 0 AND l.deductions_status = '1'
                        ...
                        <tr>
                            ...
                            <td class = "text-align-right">
                                ...
                                if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'delete')){
                                        if($row['deductions_approvalstatus'] == 'Draft'){
                                ?>
