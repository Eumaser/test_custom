...
//                                $this->getPRFForm($label_col_sm,$field_col_sm,$disabled);
                  ...
                  <div class="box-footer" style = 'clear:both'>
                    ...
                    ?>
                        ...
                        ?>
                        <button type = "submit" class="btn btn-info save-order" title="Save above.">Save</button>
                        <?php
            ...
            var data = "action=getItemDescJson&qt_type=" + qtype + "&order_item_id="+$(this).val();
             $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#ordl_uom_'+line).val(jsonObj.item_product_uom);
                    <?php if ($this->document_type == 'QT') { ?>
            ...
            ?>
                <tr id = "line_<?php echo $line;?>" class="tbl_grid_odd" line = "<?php echo $line;?>">
                    ...
                    <td style="width:100px;">
                        <select style = "" line = "<?php echo $line;?>" id = "ordl_pro_type_<?php echo $line;?>" class="form-control order-quotation-type-item" <?php echo $disabled;?>>
                    ...
                    <td style="width:350px;">
                        ...
                        <select style = "" line = "<?php echo $line;?>" id = "ordl_pro_id_<?php echo $line;?>" class="form-control order-quotation-item-list" <?php echo $disabled;?>>
...
<!-- Remark      --><td style="width:120px;"><textarea  rows="1" cols="15"  id = "ordl_pro_remark_<?php echo $line;?>" class="form-control" <?php echo $readonly;?>><?php echo $row['ordl_pro_remark'];?></textarea></td>
            ...
            <?php if($this->document_type != 'PU' && $this->document_type != 'DO'){ ?>
            <tr id="order_total_price">
            <td <?php if($this->document_type != 'PO' && $this->document_type != 'GRN' ){ ?>colspan="8"<?php }else{ ?>colspan="7"<?php } ?> align="right">Total (<span class = 'base_currency_span'><?php echo $this->order_currency_code;?></span>):</td>
                <td class="order-subtotal text-align-right" style="width:100px;"><input type="text" class="form-control text-align-right" id="order_subtotal" name="order_subtotal" value = "<?php echo num_format($this->order_subtotal - $this->order_disctotal);?>" disabled></td>
                <td colspan="2"></td>
            </tr>
            <?php // if(!empty($this->order_discheadertotal) && ($this->order_discheadertotal > 0)){?>
            <tr id="order_discount_price">
            ...
            <?php // } ?>
            <tr id="order_tax_price">
                <td <?php if($this->document_type != 'PO' && $this->document_type != 'GRN'){ ?>colspan="8"<?php }else{ ?>colspan="7"<?php } ?> align="right">Tax Amount <?php echo system_gst_percent;?>%(<span class = 'base_currency_span'><?php echo $this->order_currency_code;?></span>):</td>
                <td class="order-taxtotal text-align-right" style="width:100px;"><input type="text" class="form-control text-align-right" id="order_taxtotal" name="order_taxtotal" value = "<?php echo num_format($this->order_taxtotal);?>" disabled></td>
                <td colspan="2"></td>
            </tr>
            <tr id="order_grandtotal_price">
                <td <?php if($this->document_type != 'PO' && $this->document_type != 'GRN'){ ?>colspan="8"<?php }else{ ?>colspan="7"<?php } ?> align="right"><b>Grand Total (<span class = 'base_currency_span'><?php echo $this->order_currency_code;?></span>)</b>:</td>
                <td class="order-grandtotal text-align-right" style="width:100px;"><input type="text" class="form-control text-align-right" id="order_grandtotal" name="order_grandtotal" value = "<?php echo num_format($this->order_grandtotal);?>" disabled></td>
                <td colspan="2"></td>
            </tr>
            <?php } ?>
        </tbody>
        <tfoot>
            <tr>
                <td id="total" colspan="8">
                    <!-- stopped at 11:00am, 15-Jan-2018 -->
                </td>
            </tr>
        </tfoot>
    </table>
...
o               WHERE  $wherestring";
    ...
    <?php } ?>
            <?php if($this->document_type != 'PO' && $this->document_type != 'GRN' && $this->document_type != 'DO') { ?>
            <div class="form-group">
        ...
        <div class="form-group">
            ...
            <!-- Hide Currency from Delivery Order -->
    ...
    -->
            <!-- Hide following in Quotation and Delivery Order -->
