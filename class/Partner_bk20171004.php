          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;' onclick = "window.location.href='partner.php?type=<?php echo $this->type;?>'">Search</button>
          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;' onclick = "window.location.href='partner.php?type=<?php echo $this->type;?>'">Search</button>
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;margin-right:10px;' onclick = "window.location.href='partner.php?action=createForm&type=<?php echo $this->type;?>'">Create New Partner</button>
          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;' onclick = "window.location.href='partner.php?type=<?php echo $_REQUEST['type'];?>'">Search</button>
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
          ...
          <table id="partner_table" class="table table-bordered table-hover">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo num_format($order->getSubTotalAmt() - $order->getTotalDiscAmt());?></td>
                    <td><?php echo num_format($order->getTotalGstAmt());?></td>
          ...
          <table id="partner_table" class="table table-bordered table-hover">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row['partner_name'];?></td>
                    <td><?php echo $row['empl_name'];?></td>
                    <td><?php echo num_format($invoice->getSubTotalAmt() - $invoice->getTotalDiscAmt());?></td>
                    <td><?php echo num_format($invoice->getTotalGstAmt());?></td>
