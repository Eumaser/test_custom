...
class Product {
    ...
    public function create(){
        $table_field = array('product_category','product_part_no','product_desc','product_remark',
                            ...
                            'product_cr_cummins','product_cr_cats','product_location');
        $table_value = array($this->product_category,$this->product_part_no,$this->product_desc,$this->product_remark,
                            ...
                            $this->product_cr_cummins,$this->product_cr_cats,$this->product_location);
...
<script type="text/javascript" src="http://www.sanwebe.com/assets/public/js/jquery.form.min.js"></script>
   ...
   <div id="bar_color"></div>
	 ...
	 */
	$aColumns = array('No','category_code','product_part_no','product_desc','product_sale_price','product_status','');
    ...
    ?>
        <div class="col-sm-9">
            ...
            <div class="form-group">
              <label for="product_part_no" class="col-sm-2 control-label">Part No</label>
              <div class="col-sm-3">
                   <input type="text" class="form-control" id="product_part_no" name="product_part_no" value = "<?php echo $this->product_part_no;?>" placeholder="Part No">
              </div>
