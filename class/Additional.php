          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;' onclick = "window.location.href='additional.php'">Search</button>
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;margin-right:10px;' onclick = "window.location.href='additional.php?action=createForm'">Create New</button>
                <?php }?>
              </div>
    ...
    $(document).ready(function() {
        ...
        $("#additional_form").validate({
                  ...
                  messages:
                  {
                      additional_title:
                      {
                          required: "Please enter Additional Title."
                      },
                      additional_empl_id:
                      {
                  ...
                  <table id="additional_table" class="table table-bordered table-hover">
                    ...
                    <?php   
                      $sql = "SELECT l.*,empl.empl_name,alt.additionaltype_code
                              ...
                              WHERE l.additional_id > 0 AND l.additional_status = '1'
                        ...
                        <tr>
                            ...
                            <td class = "text-align-right">
                                ...
                                if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'delete')){
                                        if($row['additional_approvalstatus'] == 'Draft'){
                                ?>
