...
class Product {
    ...
    public function create(){
        $prodExist = getDataCountBySql("db_product"," WHERE product_part_no = '".trim($this->product_part_no)."' AND product_status = 1");
        if($prodExist > 0){
            return false;
        }
        $table_field = array('product_category','product_part_no','product_desc','product_remark',
                            ...
                            'product_n_wt','product_g_wt','product_uom','product_location',
                            'product_stock','product_lowstock','product_name');
        $table_value = array($this->product_category,$this->product_part_no,$this->product_desc,$this->product_remark,
                            ...
                            $this->product_n_wt,$this->product_g_wt,$this->product_uom,$this->product_location,
                            $this->product_stock,$this->product_lowstock,$this->product_name);
          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title"><?php if($this->currency_id > 0){ echo "Update Product";}else{ echo "Create New Product";}?></h3>
                <button type = "button" class="btn btn-primary pull-right" style = '' onclick = "window.location.href='product.php'">Back to listing</button>
      ...
      <div class="">
        ...
        $sql = "SELECT product.*,cy.category_code
                ...
                WHERE product.product_id > 0 limit 0,100";
                      $query = mysql_query($sql);
        //$i = 1;
        $test =     mysql_fetch_array($query); //edr
         ?>
...
//                      $query = mysql_query($sql);
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $row['product_remark'];?></td>
...
<script type="text/javascript" src="http://www.sanwebe.com/assets/public/js/jquery.form.min.js"></script>
   ...
   <div id="bar_color"></div>
	 ...
	 */
	$aColumns = array('No','category_code','product_part_no','product_name','product_desc','product_remark','product_stock','product_sale_price','');
        ...
        <div class="col-sm-9">
            ...
            <div class="form-group">
              ...
              <label for="product_location" class="col-sm-2 control-label">Location <?php echo $mandatory;?></label>
                <div class="col-sm-3">
                    <textarea class="form-control" rows="2" id="product_location" name="product_location" placeholder="Location"><?php echo $this->product_location;?></textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="product_remark" class="col-sm-2 control-label">Remark<?php //echo $mandatory;?></label>
                <div class="col-sm-3">
                  <textarea class="form-control" rows="2" id="product_remark" name="product_remark" placeholder="Is this from a kit?"><?php echo $this->product_remark;?></textarea>
                </div>
                <label for="product_uom" class="col-sm-2 control-label">UOM</label>
                <div class="col-sm-3">
                     <select class="form-control select2" id="product_uom" name="product_uom">
                         <?php echo $this->uomCtrl;?>
                     </select>
                </div>
            </div>
        </div>
