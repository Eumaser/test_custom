...
class Login {
    ...
    public function loginProcess(){
        ...
        //    $sql = "SELECT COUNT(*) as total,empl.partner_name as empl_name,empl.partner_id as empl_id,empl.partner_code as empl_code,
        //            (CASE WHEN empl.partner_issubcon = '1' THEN  '7' ELSE '6' END) as empl_group
        //           FROM db_partner empl
        //           WHERE empl.partner_login_id = '$this->login_email'
        //           AND empl.partner_login_password = '$this->login_password' AND empl.partner_status = '1'";
        //    $_SESSION['empl_type'] = $this->login_type;
        //}
...
//                echo $row['empl_group'];die;
  ...
  <head>
    ...
    <title>KC Parts & Services (S) Pte. Ltd. | Log in</title>
    <?php 
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
            <div class="panel-heading text-center panel-default" style="background-color: #FFFFFF;border-color: #858888;">
                <h1 class="logo" style="font-size: 19px">
                    <img src="dist/img/logo_login.png">
                </h1>
            </div>
      ...
      <div class="login-box-body">
        ...
        <form id = 'login_form' method="post" onsubmit = "return login()">
          <!--<div class="form-group has-feedback">
              <select name = 'login_type' id = 'login_type' name = 'login_type' style = 'width: 100%;padding:7px;' >
                  <option value = '0'>SELECT LOGIN TYPE</option>
                  <option value = 'EMPLOYEE'>KC PARTS & SERVICES (S) PTE LTD</option>
