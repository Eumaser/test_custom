...
//        }
    ...
    public function getInputForm($action){
        ...
        if($this->document_type == 'SI'){
            $isgenerated = getDataCountBySql("db_order"," WHERE order_generate_from = '$this->invoice_id' AND order_status = 1 AND order_generate_from > 0");
        }
  ...
  <body class="hold-transition skin-blue layout-top-nav">
    ...
    public function fetchOrderNoDetail($docType,$orderNo){
        ...
        if($docType == 'QT'){
            ...
            $fromSql = " db_order qt LEFT JOIN db_invoice si ON si.invoice_generate_from = qt.order_id LEFT JOIN db_order do ON do.order_generate_from = si.invoice_id LEFT JOIN db_order pu ON pu.order_generate_from = do.order_id ";
            ...
            $fromSql = " db_invoice si LEFT JOIN db_order do ON do.order_generate_from = si.invoice_id LEFT JOIN db_order pu ON pu.order_generate_from = do.order_id ";
            ...
            $fromSql = " db_order do LEFT JOIN db_order pu ON pu.order_generate_from = do.order_id ";
