<?php
    ...
    $o->fork_battery =  escape($_REQUEST['fork_battery']);
    $o->fork_bat_charger =  escape($_REQUEST['fork_bat_charger']);
    $o->fork_snr =  escape($_REQUEST['fork_snr']);
    ...
    //  $count_partno = getDataCountBySql("db_product", "WHERE product_part_no = '$o->product_part_no' AND product_status = 1");
      //edr resume here
        ...
        case "update":
            ...
            break;
        case "edit":
            if($o->fetchProductDetail(" AND f.fork_id = '$o->fork_id'","","",1)){
        ...
        case "delete":
            ...
            if($order_prod>0){
                ...
                if($o->delete()){
                    ...
                    rediectUrl("forklift.php",getSystemMsg(1,'Delete data successfully'));
                }else{
                    $_SESSION['status_alert'] = 'alert-error';
                    $_SESSION['status_msg'] = "Delete fail.";
                    rediectUrl("forklift.php",getSystemMsg(0,'Delete data fail'));
                }
            }
       ...
       case "getForkModel":
          $model = $o->select->getForkModelCtrl("","Y","AND fork_brand = '$o->fork_brand'");
            echo json_encode(array('fork_model'=>$model));
            exit();
            break;
