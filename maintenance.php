<?php
    ...
    $o->save = $s;
    $o->document_type = 'MT';
    $o->document_name = 'Maintenance Management';
    $o->document_code = 'Maintenance';
    $o->document_url = 'Maintenance.php';
    $o->custsupp_label = 'Customer';
    $o->salesorderedby_label = "Sales Person";
    $o->document_print_url = "maintenance_print.php";
    $o->document2_print_url = "maintenance2_print.php";
    $o->menu_id = 11;
    $o->isstock = 0;
